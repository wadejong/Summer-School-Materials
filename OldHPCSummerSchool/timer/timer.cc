...
void timer_done(void)
{
  ...
  printf("Host: %s\n", host);
  printf("\n");
  printf("Timers On : %s", ctime(&timer_start));
  printf("Timers Off: %s", ctime(&timer_end));
